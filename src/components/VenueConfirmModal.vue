    ...
    <div v-if="open" class="session-check-shell" @click.self="emit('close')">
      ...
      >
        <header class="session-check-header">
          <div>
            <span class="session-check-eyebrow">Session start</span>
            <h5 id="venue-confirm-title" class="session-check-title">Confirm your venue</h5>
          </div>
          <button
            type="button"
        ...
        <div class="session-check-body">
          <p class="session-check-copy">
            ...
            for this face-to-face session?
          </p>
          <p class="session-check-note">
            Your answer is saved with a timestamp for session tracking.
          </p>
        </div>
...
const locationLabel = computed(() => props.location || 'the venue')
