...
typography:
  ...
  display-stack: "Hanken Grotesk, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif"
  body-stack: "Inter, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif"
  headline-xl:
    fontSize: "48px"
    fontWeight: "700"
    lineHeight: "1.2"
...
patterns:
  ...
  aurora-bento-dashboard:
    ...
    note: "Frosted glass bento cards with real product data only"
---
